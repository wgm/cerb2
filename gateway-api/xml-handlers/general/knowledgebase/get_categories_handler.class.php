 ...
 *
 */
class get_categories_handler extends xml_parser
{
   /**
    ...
    */
   function get_categories_handler(&$xml) {
      $this->xml =& $xml;
   }
...
//      }
      ...
      if($obj->get_categories() === FALSE) {
         xml_output::error(0, 'Failed to get knowledgebase category listing');
      }
      else {
         xml_output::success();
      }
