...
/**
 * This class handles getting a department
 *
 */
class get_department_handler extends xml_parser
{
   /**
    ...
    *
    * @param object $xml
    * @return get_department_handler
    */
   function get_department_handler(&$xml) {
      $this->xml =& $xml;
   }
   ...
   function process() {
      ...
      if($obj->get_department($id) === FALSE) {
