...
/**
 * This class handles unassigning a team to a department
 *
 */
class unassign_team_handler extends xml_parser
{
   /**
    ...
    *
    * @param object $xml
    * @return unassign_team_handler
    */
   function unassign_team_handler(&$xml) {
      $this->xml =& $xml;
   }
   ...
   function process() {
      ...
      if($obj->unassign_team($id, $team_id) === FALSE) {
         xml_output::error(0, 'Failed to unassign team to department');
      }
      else {
         xml_output::success();
      }
