 ...
 *
 */
class get_address_list_handler extends xml_parser
{
   /**
    ...
    *
    * @param object $xml
    * @return get_address_list_handler
    */
   function get_address_list_handler(&$xml) {
      $this->xml =& $xml;
   }
   ...
   function process() {
      ...
      if($obj->get_address_list($filters) === FALSE) {
         xml_output::error(0, 'Failed to get contact list');
      }
      else {
         xml_output::success();
      }
