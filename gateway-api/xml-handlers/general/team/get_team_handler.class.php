...
/**
 * This class handles getting teams detailed info
 *
 */
class get_team_handler extends xml_parser
{
   /**
   ...
   function process() {
      ...
      if($obj->get_team($team_id) === FALSE) {
         xml_output::error(0, 'Failed to get team detailed info');
      }
      else {
         xml_output::success();
      }
