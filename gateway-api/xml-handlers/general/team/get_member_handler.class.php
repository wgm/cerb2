 ...
 *
 */
class get_member_handler extends xml_parser
{
   /**
    ...
    *
    * @param object $xml
    * @return get_member_handler
    */
   function get_member_handler(&$xml) {
      $this->xml =& $xml;
   }
   ...
   function process() {
      ...
      if($obj->get_member($team_id, $agent_id) === FALSE) {
         xml_output::error(0, 'Failed to get detailed member info');
      }
      else {
         xml_output::success();
      }
