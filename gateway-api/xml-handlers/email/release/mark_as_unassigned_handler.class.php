 ...
 *
 */
class mark_as_unassigned_handler extends xml_parser
{
   /**
    ...
    *
    * @param object $xml
    * @return mark_as_unassigned_handler
    */
   function mark_as_unassigned_handler(&$xml) {
      $this->xml =& $xml;
   }
   ...
   function process() {
      ...
      if($obj->unassign($ticket_id) === FALSE) {
         xml_output::error(0, 'Failed to unassign ticket');
      }
      else {
         xml_output::success();
      }
