 ...
 *
 */
class get_agent_skills_handler extends xml_parser
{
   /**
    ...
    *
    * @param object $xml
    * @return get_agent_skills_handler
    */
   function get_agent_skills_handler(&$xml) {
      $this->xml =& $xml;
   }
   ...
   function process() {
      ...
      if($skills->get_agent_skills($agent_id) === FALSE) {
