 ...
 *
 */
class hide_tickets_handler extends xml_parser
{
   /**
    ...
    *
    * @param object $xml
    * @return hide_tickets_handler
    */
   function hide_tickets_handler(&$xml) {
      $this->xml =& $xml;
   }
   ...
   function process() {
      ...
      if($obj->hide_tickets($tickets, general_users::get_user_id()) === FALSE) {
