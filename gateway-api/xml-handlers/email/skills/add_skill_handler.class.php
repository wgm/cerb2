...
/**
 * This class adds a skill to db
 *
 */
class add_skill_handler extends xml_parser
{
   /**
    ...
    *
    * @param object $xml
    * @return add_skill_handler
    */
   function add_skill_handler(&$xml) {
      $this->xml =& $xml;
   }
   ...
   function process() {
      ...
      if($skills->add_skill($name, $description, $category_id) === FALSE) {
         xml_output::error(0, 'Failed to add skill');
      }
      else {
         xml_output::success();
      }
