...
/**
 * This class removes a chat room
 *
 */
class remove_handler extends xml_parser
{
   /**
   ...
   function process() {
      ...
      if($rooms_obj->remove_room($room_id) === FALSE) {
         xml_output::error(0, 'Failed to remove room!');
      }
      else {
         xml_output::success();
      }
