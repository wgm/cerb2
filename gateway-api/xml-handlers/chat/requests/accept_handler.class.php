...
/**
 * This class accepts a chat request
 *
 */
class accept_handler extends xml_parser
{
   /**
   ...
   function process() {
      ...
      if($req_obj->accept_chat_request($request_id) === FALSE) {
         xml_output::error(0, 'Failed to accept chat request');
      }
      else {
         xml_output::success();
      }
