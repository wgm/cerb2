...
/**
 * This class handles getting the frame HTML for text
 *
 */
class getframe_text_handler
{  
   /**
    * Class constructor
    *
    * @return getframe_text_handler
    */
   function getframe_text_handler() {
   ...
   function process() {
      ...
      if($class_obj->getframe_text($GUID, $room_id) === FALSE) {
         html_output::error(0, 'Failed to get frame for text!'); 
      }
      else {
         html_output::success();
      }
