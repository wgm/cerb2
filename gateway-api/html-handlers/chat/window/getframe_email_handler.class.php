 ...
 *
 */
class getframe_email_handler
{  
   /**
    * Class constructor
    *
    * @return getframe_email_handler
    */
   function getframe_email_handler() {
   ...
   function process() {
      ...
      if($class_obj->getframe_email($GUID, $dept_id) === FALSE) {
         html_output::error(0, 'Failed to get email frame!'); 
      }
      else {
         html_output::success();
      }
