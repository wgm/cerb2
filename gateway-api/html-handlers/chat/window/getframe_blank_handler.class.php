...
/**
 * This class handles getting the blank frame HTML
 *
 */
class getframe_blank_handler
{  
   /**
    * Class constructor
    *
    * @return getframe_blank_handler
    */
   function getframe_blank_handler() {
   ...
   function process() {
      ...
      if($class_obj->getframe_blank($GUID) === FALSE) {
         html_output::error(0, 'Failed to get blank frame!'); 
      }
      else {
         html_output::success();
      }
