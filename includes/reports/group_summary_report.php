<?php
define("REPORT_NAME","Group Summary Report");
define("REPORT_SUMMARY","Date range breakdown by group for each agent showing average handle time and number of e-mails handled.");
...
class cer_GroupSummaryReport extends cer_ReportModule
{
	function generate_report()
	{
		...
		foreach($sorted_group_times as $group_time)
		{
			...
			$new_row->cols[0] = new cer_ReportDataCol("Group: " . $group_time->group_name);
			$new_row->cols[0]->col_span = 4;
			array_push($this->report_data->rows,$new_row);
