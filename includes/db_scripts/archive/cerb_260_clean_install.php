...
define("DB_SCRIPT_NAME","Cerberus Helpdesk 2.6.x Clean Database Install");
...
function init_table_field_group_bindings()
{
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `field_group_bindings` ( ".
		...
		"`group_template_id` BIGINT UNSIGNED NOT NULL default '0',".
...
function init_table_public_gui_profiles()
{
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `public_gui_profiles` (".
								...
								"  `login_plugin_id` bigint(20) unsigned NOT NULL default '0',".
...
function init_table_queue_catchall()
{
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `queue_catchall` (".
		...
		"`catchall_to_qid` BIGINT UNSIGNED NOT NULL default '0',".
		"`catchall_order` INT UNSIGNED NOT NULL default '0',".
...
function init_table_search_index_exclude()
{
	...
	if(0==$cerberus_db->num_rows($result)) {
		$sql = "INSERT IGNORE INTO `search_index_exclude` (exclude_word) VALUES ".
	       ...
	       "('the'),('you'),('for'),('any'),('not'),('and'),('has'),('let'),('can'),('was'),('are'),('get'),".
	       "('this'),('have'),('from'),('that'),('your'),('been'),('know'),('need'),('with'),('will'),".
	       "('there'),('might'),('but'),('means'),('our'),('upon'),('all'),('when'),('while'),('among'),('now'),('would'),".
