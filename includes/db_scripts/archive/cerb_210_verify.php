...
|
| File: cerb_db_verify.php
|
| Purpose: Verifies the current version DB structure
|
...
define("DB_SCRIPT_NAME","Cerberus Helpdesk 2.1.0 Database Verification Script");
...
function cer_init()
{
	...
	echo "<br><font color='green'><b>Verification complete!</b></font><br>";
	return true;
}
