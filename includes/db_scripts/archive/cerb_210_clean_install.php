...
|
| File: cerb_210_clean_install.php
|
| Purpose: Installs a clean 2.1.0 database structure
|
...
define("DB_SCRIPT_NAME","Cerberus Helpdesk 2.1.0 Release Clean Database Install");
...
function set_precursor_hashes()
{
	...
	// [JAS]: Since this is a clean 2.1.0, denote the 2.1.0 upgrade has run too
	$TABLE_HSH = new CER_DB_TABLE("db_script_hash");
	if($TABLE_HSH->table_exists) {
...
function init_table_address_values()
{
	...
	$TABLE_DEF->fields["field_id"] = new CER_DB_FIELD("field_id","bigint(20)","","","0","");
...
function init_table_configuration()
{
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `configuration` (".
		...
		"`master_db_name` char(64) NOT NULL default '',".
		"`master_db_pass` char(64) NOT NULL default '',".
		"`master_db_server` char(64) NOT NULL default '',".
		"`master_db_user` char(64) NOT NULL default '',".
	...
	$TABLE_DEF->fields["demo"] = new CER_DB_FIELD("demo","tinyint(4)","","","0","");
	...
	$TABLE_DEF->fields["master_db_name"] = new CER_DB_FIELD("master_db_name","char(64)","","","","");
	$TABLE_DEF->fields["master_db_pass"] = new CER_DB_FIELD("master_db_pass","char(64)","","","","");
	$TABLE_DEF->fields["master_db_server"] = new CER_DB_FIELD("master_db_server","char(64)","","","","");
	$TABLE_DEF->fields["master_db_user"] = new CER_DB_FIELD("master_db_user","char(64)","","","","");
...
function init_table_queue_access()
{
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `queue_access` (".
  		...
  		"`queue_access` enum('read','write') NOT NULL default 'read',".
	...
	$TABLE_DEF->fields["queue_access"] = new CER_DB_FIELD("queue_access","enum('read','write')","","","read","");
...
function init_table_thread()
{
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `thread` (".
  		...
  		"`thread_type` enum('email','comment') NOT NULL default 'email',".
	...
	$TABLE_DEF->fields["thread_type"] = new CER_DB_FIELD("thread_type","enum('email','comment')","","","email","");
...
function init_table_user()
{
	...
	$TABLE_DEF->create_sql = "CREATE TABLE `user` (".
  		...
  		"`user_password` char(16) NOT NULL default '',".
	...
	$TABLE_DEF->fields["user_password"] = new CER_DB_FIELD("user_password","char(16)","","","","");
