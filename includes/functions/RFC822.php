...
/*!
  \file RFC822.php
  \brief PEAR RFC 822 compliant e-mail address validation.
  ...
  \version 1.3
	\date (c) Copyright 1997-2002 The PHP Group
...
class Mail_RFC822
{
    ...
    */
    ...
    function parseAddressList($address = null, $default_domain = null, $nest_groups = null, $validate = null, $limit = null)
    {
        ...
        // get here
        @set_time_limit(30); // [JAS]: Suppress warnings in safe-mode
    ...
    function _validatePhrase($phrase)
    {
        ...
        for ($i = 0; $i < count($phrase_parts); $i++) {
            ...
            if (substr($phrase_parts[$i], 0, 1) == '"') {
							// [JAS]: Removed quoted part check.  We're fine if the phrase doesn't validate. i.e. "Jeff Standen" Webgroup Media <jeff@wgm.cc>
    ...
    function validateMailbox(&$mailbox)
    {
        ...
        while (strlen(trim($_mailbox)) > 0) {
            ...
            if ($before_comment != $_mailbox) {
				...
				// [JAS]: Error reporting patch.
        if(!isset($comments) || empty($comments)) $comments = array();
        ...
        if (substr($mailbox, -1) == '>' && substr($mailbox, 0, 1) != '<') {
            ...
            // [JAS]: If our phrase fails validation, simply null it out.
            if($this->_validatePhrase($phrase) === false)
            	$phrase = "";
            
            // [JAS]: If our routing address fails, don't validate mailbox
            if (($route_addr = $this->_validateRouteAddr($route_addr)) === false)
            	return false;
