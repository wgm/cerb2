<table cellpadding="4" cellspacing="1" border="0" bgcolor="#BABABA" width='100%'>
	<tr>
		<td bgcolor='#ECECEC'>
			<span class="cer_display_header">Keywords:</span><br>
		</td>
	</tr>
	<tr>
		<td bgcolor='#FFFFFF'>
			<span class="cer_maintable_text">{$kb_keyword_string|escape:"htmlall"}</span>
		</td>
	</tr>
</table>
<br>

<span class="cer_display_header">Knowledgebase Keyword Matches:</span><br>
...
{if count($articles) > 0}
	...
	<table width="100%" border="0" cellspacing="1" cellpadding="1">
    	<tr bgcolor="#999999"> 
	        ...
	        <td width="1%" class="cer_maintable_header" bgcolor="#0099FF" align="center" nowrap>&nbsp;Match&nbsp;</td>
      	</tr>
	        ...
	        <tr class="{if %article.rownum% % 2 == 0}cer_maintable_text_1{else}cer_maintable_text_2{/if}">
	          <td width="1%" align="right" nowrap><a href="{$articles[article]->article_url}" class="cer_maintable_text">{$articles[article]->article_id}</a>&nbsp;</td>
				...
				<td width="1%" valign="middle" align="center" nowrap>
					&nbsp;{$articles[article]->article_matches}&nbsp;
				</td>
	        </tr>
		{/section}
...
{else}
	<i><span class="cer_maintable_text">No matching articles.</span></i>
	<br>
{/if}
