...
<br>
	<form action="" method="post">
		...
		<table border="0" cellpadding="5" cellspacing="0">
			<tr>
				<td><span class="cer_maintable_heading">Agent Reply Within: </span><br><input type="text" name="report_search_text" value="{$report_list->report->report_search_text}" maxlength="10" size="5" class="cer_footer_text"> <span class="cer_maintable_text">hour(s)</span></td>
