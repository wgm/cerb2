	...
	<form action="" method="post">
		...
		<input type="hidden" name="sid" value="{$session_id}">
			...
			<tr>
				...
				<td><span class="cer_maintable_heading">Search By Requester:</span><br><input type="text" name="report_search_text" value="{$report_list->report->report_search_text}"></td>
